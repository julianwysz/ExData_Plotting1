...
with(housePwrConsum, plot(Global_active_power ~ datesCol, col = "black", type= "l", xlab ="", ylab ="Global Active Power"))

with(housePwrConsum, plot(Voltage ~ datesCol, col = "black", type= "l", xlab ="", ylab ="Voltage"))
...
with(housePwrConsum, plot(Global_reactive_power ~ datesCol, col = "black", type= "l", xlab =""))
